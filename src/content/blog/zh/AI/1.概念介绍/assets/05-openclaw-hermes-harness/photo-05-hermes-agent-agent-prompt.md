# photo-05: 三、Hermes Agent 为什么会出现：因为 Agent 需要"记住"和"成长"

Article: src/content/blog/zh/AI/1.概念介绍/05.OpenClaw、Hermes和Harness关系.md
Section: 三、Hermes Agent 为什么会出现：因为 Agent 需要"记住"和"成长"
Asset target: src/content/blog/zh/AI/1.概念介绍/assets/05-openclaw-hermes-harness/photo-05-hermes-agent-agent.png
