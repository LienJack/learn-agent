...
aliases:
  ...
  - Agent Harness 分层
heroImage: './assets/05-openclaw-hermes-harness/cover-openclaw-hermes-harness.png'
---
...
![OpenClaw、Hermes 和 Harness：它们到底是什么关系 - 二、OpenClaw 为什么会出现：因为 Agent 需要"入口"和"控制平面"](./assets/05-openclaw-hermes-harness/photo-02-openclaw-agent.png)
...
![OpenClaw、Hermes 和 Harness：它们到底是什么关系 - 三、Hermes Agent 为什么会出现：因为 Agent 需要"记住"和"成长"](./assets/05-openclaw-hermes-harness/photo-05-hermes-agent-agent.png)
...
![OpenClaw、Hermes 和 Harness：它们到底是什么关系 - 四、Harness.io 为什么会出现：因为 Agent 需要进入"企业流程"](./assets/05-openclaw-hermes-harness/photo-06-harness-io-agent.png)
...
![OpenClaw、Hermes 和 Harness：它们到底是什么关系 - 五、把三者放回一条链里](./assets/05-openclaw-hermes-harness/photo-07-item-2694edf2.png)
