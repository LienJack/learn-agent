...
![向量嵌入 手绘图 1：文本变成语义坐标](./assets/04-photo-01-text-to-semantic-coordinates.jpg)
...
![向量嵌入 手绘图 2：常见向量存储方案选择地图](./assets/04-photo-02-vector-store-landscape.jpg)
...
![向量嵌入 手绘图 3：语义检索与关键词检索合流](./assets/04-photo-03-hybrid-search-coordinate.jpg)
...
![向量嵌入 手绘图 4：向量数据库选型也要看排错能力](./assets/04-photo-04-debuggable-vector-db.jpg)
