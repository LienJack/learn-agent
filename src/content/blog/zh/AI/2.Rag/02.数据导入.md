...
![数据导入 手绘图 1：从文件到证据](./assets/02-photo-01-file-to-evidence.jpg)
...
![数据导入：文件解析与清洗](./assets/02-data-import.jpg)
...
![数据导入 手绘图 2：文件类型路由器](./assets/02-photo-02-file-router.jpg)
...
![数据导入 手绘图 3：数据清洗质量门](./assets/02-photo-03-cleaning-gate.jpg)
...
![数据导入 手绘图 4：元数据让答案回到原文](./assets/02-photo-04-metadata-backlink.jpg)
