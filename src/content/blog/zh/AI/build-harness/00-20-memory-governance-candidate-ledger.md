---
title: "Memory Governance：candidate ledger 到 governance store"
...
# Memory Governance：candidate ledger 到 governance store

到了第 20 篇，我们的小型 CLI Agent 已经能做不少事了。

它能接入真实 provider。

它能把模型输出拆成 intent。

它能通过 tool runtime 执行文件、搜索和命令。
...
![Memory Governance：candidate ledger 到 governance store Mermaid 1](assets/00-20-memory-governance-candidate-ledger/mermaid-01.png)
...
## 二、Memory 不是 State，也不是 Session，也不是 RAG
...
![Memory Governance：candidate ledger 到 governance store Mermaid 2](assets/00-20-memory-governance-candidate-ledger/mermaid-02.png)
...
## 五、从 observation 到 candidate：提取不是相信
...
![Memory Governance：candidate ledger 到 governance store Mermaid 3](assets/00-20-memory-governance-candidate-ledger/mermaid-03.png)

这张图里最重要的不是 extractor。
...
![Memory Governance：candidate ledger 到 governance store Mermaid 4](assets/00-20-memory-governance-candidate-ledger/mermaid-04.png)
...
![Memory Governance：candidate ledger 到 governance store Mermaid 5](assets/00-20-memory-governance-candidate-ledger/mermaid-05.png)
...
![Memory Governance：candidate ledger 到 governance store Mermaid 6](assets/00-20-memory-governance-candidate-ledger/mermaid-06.png)
...
![Memory Governance：candidate ledger 到 governance store Mermaid 7](assets/00-20-memory-governance-candidate-ledger/mermaid-07.png)
...
```text
Memory 不是把过去塞进未来，而是把可复用知识经过治理后，有边界地带到未来。
```
