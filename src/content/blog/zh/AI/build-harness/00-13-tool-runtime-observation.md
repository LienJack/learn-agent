---
title: "Tool Runtime：从 ToolIntent 到 Observation"
description: "把模型提出的 ToolIntent 沿 registry、validation、permission、scheduler、sandbox、normalization 管线治理成 Observation。"
author: LienJack
pubDate: 2026-05-29
...
这句话听起来已经足够像工程原则了。但真正开始写代码时，很快会发现它还不够。
...
![Tool Runtime：从 ToolIntent 到 Observation Mermaid 1](assets/00-13-tool-runtime-observation/mermaid-01.png)
...
![Tool Runtime：从 ToolIntent 到 Observation Mermaid 2](assets/00-13-tool-runtime-observation/mermaid-02.png)
...
![Tool Runtime：从 ToolIntent 到 Observation Mermaid 3](assets/00-13-tool-runtime-observation/mermaid-03.png)
...
![Tool Runtime：从 ToolIntent 到 Observation Mermaid 4](assets/00-13-tool-runtime-observation/mermaid-04.png)
...
![Tool Runtime：从 ToolIntent 到 Observation Mermaid 5](assets/00-13-tool-runtime-observation/mermaid-05.png)
...
![Tool Runtime：从 ToolIntent 到 Observation Mermaid 6](assets/00-13-tool-runtime-observation/mermaid-06.png)
