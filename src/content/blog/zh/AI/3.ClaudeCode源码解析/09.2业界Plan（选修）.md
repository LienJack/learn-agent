---
title: 9.2 业界的 Plan 设计：Plan 不是让模型多想一会儿
...
# 9.2 业界的 Plan 设计：Plan 不是让模型多想一会儿
...
- [Codex Agent 协作与编排模型](../../../wiki/AI/codex-agent-协作与编排模型.md)
- [Claude Code Agent 协作机制总览](../../../wiki/AI/claude-code-agent-协作机制总览.md)
- [Claude Code Plan 模式与结构化工作流（教材版）](../../../wiki/AI/claude-code-book-14-plan-模式与结构化工作流-教材版.md)
- [Claude Code Subagents 官方文档](https://code.claude.com/docs/en/sub-agents)
- [Claude Code Permission Modes 官方文档](https://code.claude.com/docs/en/permission-modes)
...
- [OpenAI Agents SDK Orchestration 官方文档](https://openai.github.io/openai-agents-python/multi_agent/)
- [Gemini Deep Research Agent 官方文档](https://ai.google.dev/gemini-api/docs/deep-research)
- [Gemini ADK Workflow Agents 官方文档](https://adk.dev/agents/workflow-agents/)
