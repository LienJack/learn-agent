...
![03.核心机制-Prompt编写 手绘图 1：Prompt Runtime 的模型工作台](./assets/03-photo-01-prompt-runtime-workbench.jpg)
...
![03.核心机制-Prompt编写 手绘图 2：system prompt 的优先级阶梯](./assets/03-photo-02-system-prompt-priority.jpg)
...
![03.核心机制-Prompt编写 手绘图 3：CLAUDE.md 的记忆层级](./assets/03-photo-03-memory-layers.jpg)
...
![03.核心机制-Prompt编写 手绘图 4：稳定段与动态段的缓存边界](./assets/03-photo-04-cache-boundary.jpg)
