---
title: 4.2 Context Manage（选修）：Agent 工程里的上下文治理
...
# 4.2 Context Manage（选修）：Agent 工程里的上下文治理
...
- [Agent 上下文管理：七维模型与上下文操作系统](../../../wiki/AI/agent-上下文管理：七维模型与上下文操作系统.md)
- [智能体上下文工程：从 Copilot 到 Deep Agent 的架构模式](../../../wiki/AI/智能体上下文工程：从-copilot-到-deep-agent-的架构模式.md)
- [Agent Harness 分层：OpenClaw、Hermes Agent 与 Harness.io 对比](../../../wiki/AI/agent-harness-分层：openclaw、hermes-agent-与-harnessio-对比.md)
- [Claude Code 源码阅读实战教程 05：上下文、记忆、压缩与恢复](../../../wiki/AI/claude-code-源码阅读实战教程-05-上下文记忆压缩与恢复.md)
- [LangChain 实战学习目录（教材版）](../../../wiki/AI/langchain-实战学习目录-教材版.md)
...
- [AutoGen Docs: Memory and RAG](https://microsoft.github.io/autogen/stable/user-guide/agentchat-user-guide/memory.html)
