---
title: 9.1 Plan：Claude Code 如何把“先想后做”做成运行时机制
...
# 9.1 Plan：Claude Code 如何把“先想后做”做成运行时机制
...
- [Claude Code Book 14：Plan 模式与结构化工作流（教材版）](../../../wiki/AI/claude-code-book-14-plan-模式与结构化工作流-教材版.md)
- [Claude Code Agent 协作机制总览](../../../wiki/AI/claude-code-agent-协作机制总览.md)
- [Claude Code 源码专题：核心机制（引擎与运行闭环）](../../../wiki/AI/claude-code-源码专题-核心机制-引擎与运行闭环.md)
