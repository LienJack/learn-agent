...
本章是 Bitmap、Bitfield 与 HyperLogLog 的主章节，重点是用较少内存表达大量状态。它们与 Set 的精确集合能力对比见[第 6 章](/blog/tech/Redis/06.Set、Sorted Set 与 GEO/)；Bitmap 作为 String 的内部关系和对象编码细节见[第 4 章](/blog/tech/Redis/04.String 的使用场景与底层实现/)与[第 11 章](/blog/tech/Redis/11.Redis 核心对象与底层数据结构/)；大范围 `BITCOUNT`、热 Key 和端到端延迟排查见[第 12 章](/blog/tech/Redis/12.Redis 高性能原理/)与[第 20 章](/blog/tech/Redis/20.性能优化、可观测性、故障诊断与综合面试/)。
