...
![RocketMQ 第 18 章：源码阅读：发送、存储、消费、事务与高可用调用链 flow 1](./assets/18-rocketmq/mermaid-01.png)
...
![RocketMQ 第 18 章：源码阅读：发送、存储、消费、事务与高可用调用链 flow 2](./assets/18-rocketmq/mermaid-02.png)
...
![RocketMQ 第 18 章：源码阅读：发送、存储、消费、事务与高可用调用链 flow 3](./assets/18-rocketmq/mermaid-03.png)
...
![RocketMQ 第 18 章：源码阅读：发送、存储、消费、事务与高可用调用链 flow 4](./assets/18-rocketmq/mermaid-04.png)
...
![RocketMQ 第 18 章：源码阅读：发送、存储、消费、事务与高可用调用链 flow 5](./assets/18-rocketmq/mermaid-05.png)
...
![RocketMQ 第 18 章：源码阅读：发送、存储、消费、事务与高可用调用链 flow 6](./assets/18-rocketmq/mermaid-06.png)
...
![RocketMQ 第 18 章：源码阅读：发送、存储、消费、事务与高可用调用链 flow 7](./assets/18-rocketmq/mermaid-07.png)
...
![RocketMQ 第 18 章：源码阅读：发送、存储、消费、事务与高可用调用链 flow 8](./assets/18-rocketmq/mermaid-08.png)
...
![RocketMQ 第 18 章：源码阅读：发送、存储、消费、事务与高可用调用链 flow 9](./assets/18-rocketmq/mermaid-09.png)
...
![RocketMQ 第 18 章：源码阅读：发送、存储、消费、事务与高可用调用链 flow 10](./assets/18-rocketmq/mermaid-10.png)
...
![RocketMQ 第 18 章：源码阅读：发送、存储、消费、事务与高可用调用链 flow 11](./assets/18-rocketmq/mermaid-11.png)
