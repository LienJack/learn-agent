...
![RocketMQ 第 4 章：Producer 发送模型、路由选择、重试机制与底层发送链路 flow 1](./assets/04-producer/mermaid-01.png)
...
![RocketMQ 第 4 章：Producer 发送模型、路由选择、重试机制与底层发送链路 flow 2](./assets/04-producer/mermaid-02.png)
...
![RocketMQ 第 4 章：Producer 发送模型、路由选择、重试机制与底层发送链路 flow 3](./assets/04-producer/mermaid-03.png)
...
![RocketMQ 第 4 章：Producer 发送模型、路由选择、重试机制与底层发送链路 flow 4](./assets/04-producer/mermaid-04.png)
