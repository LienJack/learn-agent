...
![RocketMQ FIFO 顺序消息速览总结图](./assets/09-fifo/rocketmq-fifo-summary.webp)
...
![RocketMQ 第 9 章：FIFO 顺序消息：发送有序、存储有序、消费有序与并发权衡 flow 1](./assets/09-fifo/mermaid-01.png)
...
![RocketMQ 第 9 章：FIFO 顺序消息：发送有序、存储有序、消费有序与并发权衡 flow 2](./assets/09-fifo/mermaid-02.png)
...
![RocketMQ 第 9 章：FIFO 顺序消息：发送有序、存储有序、消费有序与并发权衡 flow 3](./assets/09-fifo/mermaid-03.png)
...
![RocketMQ 第 9 章：FIFO 顺序消息：发送有序、存储有序、消费有序与并发权衡 flow 4](./assets/09-fifo/mermaid-04.png)
...
![RocketMQ 第 9 章：FIFO 顺序消息：发送有序、存储有序、消费有序与并发权衡 flow 5](./assets/09-fifo/mermaid-05.png)
