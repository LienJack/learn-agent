...
![PostgreSQL Declarative Partitioning 与大型数据生命周期 flow 1](./assets/14-postgresql-declarative-partitioning/mermaid-01.png)
...
![PostgreSQL Declarative Partitioning 与大型数据生命周期 flow 2](./assets/14-postgresql-declarative-partitioning/mermaid-02.png)
