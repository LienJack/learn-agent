...
![PostgreSQL shared_buffers 架构位置](./assets/05-shared-buffers-arch.jpg)
...
![PostgreSQL shared_buffers 通过 Buffer Tag 查找 page](./assets/05-photo-01-buffer-tag-lookup.jpg)
...
![PostgreSQL shared_buffers 脏页、WAL 与后台刷盘协作](./assets/05-photo-02-dirty-page-flush.jpg)
...
![PostgreSQL Clock Sweep 淘汰算法](./assets/05-clock-sweep.jpg)
...
![PostgreSQL Clock Sweep 淘汰与内存平衡](./assets/05-photo-03-clock-sweep-balance.jpg)
...
![PostgreSQL 缓存命中 vs 未命中的路径对比](./assets/05-cache-hit-miss.jpg)
