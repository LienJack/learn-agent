...
![第 8 章全文重点总结图：分布式一致性、幂等、补偿与对账](./assets/summary-infographics/chapter-08-summary.webp)

> 图注：本章全文重点总结图，把 Redis、RocketMQ、PostgreSQL 与支付之间的事实边界、幂等键、Inbox/Outbox、补偿任务和库存守恒对账串成一页。
...
![高并发秒杀订单系统：分布式一致性、幂等、补偿与对账 flow 1](./assets/08/mermaid-01.webp)
...
![高并发秒杀订单系统：分布式一致性、幂等、补偿与对账 flow 2](./assets/08/mermaid-02.webp)
...
![高并发秒杀订单系统：分布式一致性、幂等、补偿与对账 flow 3](./assets/08/mermaid-03.webp)
...
![高并发秒杀订单系统：分布式一致性、幂等、补偿与对账 flow 4](./assets/08/mermaid-04.webp)
...
![高并发秒杀订单系统：分布式一致性、幂等、补偿与对账 flow 5](./assets/08/mermaid-05.webp)
...
![高并发秒杀订单系统：分布式一致性、幂等、补偿与对账 flow 6](./assets/08/mermaid-06.webp)
...
![高并发秒杀订单系统：分布式一致性、幂等、补偿与对账 flow 7](./assets/08/mermaid-07.webp)
...
![高并发秒杀订单系统：分布式一致性、幂等、补偿与对账 flow 8](./assets/08/mermaid-08.webp)

状态迁移规则：

![高并发秒杀订单系统：分布式一致性、幂等、补偿与对账 flow 9](./assets/08/mermaid-09.webp)
...
![高并发秒杀订单系统：分布式一致性、幂等、补偿与对账 flow 10](./assets/08/mermaid-10.webp)
