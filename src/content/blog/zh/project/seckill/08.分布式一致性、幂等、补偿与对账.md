...
![高并发秒杀订单系统：分布式一致性、幂等、补偿与对账 flow 1](./assets/08/mermaid-01.png)
...
![高并发秒杀订单系统：分布式一致性、幂等、补偿与对账 flow 2](./assets/08/mermaid-02.png)
...
![高并发秒杀订单系统：分布式一致性、幂等、补偿与对账 flow 3](./assets/08/mermaid-03.png)
...
![高并发秒杀订单系统：分布式一致性、幂等、补偿与对账 flow 4](./assets/08/mermaid-04.png)
...
![高并发秒杀订单系统：分布式一致性、幂等、补偿与对账 flow 5](./assets/08/mermaid-05.png)
...
![高并发秒杀订单系统：分布式一致性、幂等、补偿与对账 flow 6](./assets/08/mermaid-06.png)
...
![高并发秒杀订单系统：分布式一致性、幂等、补偿与对账 flow 7](./assets/08/mermaid-07.png)
...
![高并发秒杀订单系统：分布式一致性、幂等、补偿与对账 flow 8](./assets/08/mermaid-08.png)

状态迁移规则：

![高并发秒杀订单系统：分布式一致性、幂等、补偿与对账 flow 9](./assets/08/mermaid-09.png)
...
![高并发秒杀订单系统：分布式一致性、幂等、补偿与对账 flow 10](./assets/08/mermaid-10.png)
