...
![高并发秒杀订单系统：PostgreSQL 数据模型、事务、性能优化与高可用 flow 1](./assets/06-postgresql/mermaid-01.png)
...
![高并发秒杀订单系统：PostgreSQL 数据模型、事务、性能优化与高可用 flow 2](./assets/06-postgresql/mermaid-02.png)
...
![高并发秒杀订单系统：PostgreSQL 数据模型、事务、性能优化与高可用 flow 3](./assets/06-postgresql/mermaid-03.png)
...
![高并发秒杀订单系统：PostgreSQL 数据模型、事务、性能优化与高可用 flow 4](./assets/06-postgresql/mermaid-04.png)
