...
![第 9 章全文重点总结图：高可用、容灾、降级与可观测性](./assets/summary-infographics/chapter-09-summary.webp)

> 图注：本章全文重点总结图，用多可用区、RTO/RPO、组件高可用、Fail Open/Fail Closed、降级状态机、可观测性和故障决策矩阵说明系统韧性设计。
...
![高并发秒杀订单系统：系统高可用、容灾、降级与可观测性 flow 1](./assets/09-j5sr68/mermaid-01.webp)
...
![高并发秒杀订单系统：系统高可用、容灾、降级与可观测性 flow 2](./assets/09-j5sr68/mermaid-02.webp)
...
![高并发秒杀订单系统：系统高可用、容灾、降级与可观测性 flow 3](./assets/09-j5sr68/mermaid-03.webp)
...
![高并发秒杀订单系统：系统高可用、容灾、降级与可观测性 flow 4](./assets/09-j5sr68/mermaid-04.webp)
