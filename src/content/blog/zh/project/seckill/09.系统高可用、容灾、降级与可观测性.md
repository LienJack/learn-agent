...
![高并发秒杀订单系统：系统高可用、容灾、降级与可观测性 flow 1](./assets/09/mermaid-01.png)
...
![高并发秒杀订单系统：系统高可用、容灾、降级与可观测性 flow 2](./assets/09/mermaid-02.png)
...
![高并发秒杀订单系统：系统高可用、容灾、降级与可观测性 flow 3](./assets/09/mermaid-03.png)
...
![高并发秒杀订单系统：系统高可用、容灾、降级与可观测性 flow 4](./assets/09/mermaid-04.png)
