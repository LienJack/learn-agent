...
![第 10 章全文重点总结图：压测、混沌工程与容量验证](./assets/summary-infographics/chapter-10-summary.webp)

> 图注：本章全文重点总结图，集中展示压测目标、开环流量模型、业务断言、故障注入矩阵、容量报告和面试表达路径。
...
![高并发秒杀订单系统：压测、混沌工程、容量验证与面试表达 flow 1](./assets/10/mermaid-01.webp)
...
![高并发秒杀订单系统：压测、混沌工程、容量验证与面试表达 flow 2](./assets/10/mermaid-02.webp)
...
![高并发秒杀订单系统：压测、混沌工程、容量验证与面试表达 flow 3](./assets/10/mermaid-03.webp)
...
![高并发秒杀订单系统：压测、混沌工程、容量验证与面试表达 flow 4](./assets/10/mermaid-04.webp)
...
![高并发秒杀订单系统：压测、混沌工程、容量验证与面试表达 flow 5](./assets/10/mermaid-05.webp)
