...
![高并发秒杀订单系统：压测、混沌工程、容量验证与面试表达 flow 1](./assets/10/mermaid-01.png)
...
![高并发秒杀订单系统：压测、混沌工程、容量验证与面试表达 flow 2](./assets/10/mermaid-02.png)
...
![高并发秒杀订单系统：压测、混沌工程、容量验证与面试表达 flow 3](./assets/10/mermaid-03.png)
...
![高并发秒杀订单系统：压测、混沌工程、容量验证与面试表达 flow 4](./assets/10/mermaid-04.png)
...
![高并发秒杀订单系统：压测、混沌工程、容量验证与面试表达 flow 5](./assets/10/mermaid-05.png)
