...
![高并发秒杀订单系统：RocketMQ 削峰、可靠消息与积压治理 flow 1](./assets/05-rocketmq/mermaid-01.png)
...
![高并发秒杀订单系统：RocketMQ 削峰、可靠消息与积压治理 flow 2](./assets/05-rocketmq/mermaid-02.png)
...
![高并发秒杀订单系统：RocketMQ 削峰、可靠消息与积压治理 flow 3](./assets/05-rocketmq/mermaid-03.png)
...
![高并发秒杀订单系统：RocketMQ 削峰、可靠消息与积压治理 flow 4](./assets/05-rocketmq/mermaid-04.png)
...
![高并发秒杀订单系统：RocketMQ 削峰、可靠消息与积压治理 flow 5](./assets/05-rocketmq/mermaid-05.png)
...
![高并发秒杀订单系统：RocketMQ 削峰、可靠消息与积压治理 flow 6](./assets/05-rocketmq/mermaid-06.png)
...
![高并发秒杀订单系统：RocketMQ 削峰、可靠消息与积压治理 flow 7](./assets/05-rocketmq/mermaid-07.png)
