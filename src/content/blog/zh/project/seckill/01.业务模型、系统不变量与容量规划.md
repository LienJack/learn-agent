...
![高并发秒杀订单系统：业务模型、系统不变量与容量规划 flow 1](./assets/01/mermaid-01.webp)
...
![高并发秒杀订单系统：业务模型、系统不变量与容量规划 flow 2](./assets/01/mermaid-02.webp)
...
![高并发秒杀订单系统：业务模型、系统不变量与容量规划 flow 3](./assets/01/mermaid-03.webp)
...
![高并发秒杀订单系统：业务模型、系统不变量与容量规划 flow 4](./assets/01/mermaid-04.webp)
...
![高并发秒杀订单系统：业务模型、系统不变量与容量规划 flow 5](./assets/01/mermaid-05.webp)
...
![高并发秒杀订单系统：业务模型、系统不变量与容量规划 flow 6](./assets/01/mermaid-06.webp)

### 9.5 支付与超时取消竞态

支付回调和超时取消必须竞争同一个 PostgreSQL 订单行。

![高并发秒杀订单系统：业务模型、系统不变量与容量规划 flow 7](./assets/01/mermaid-07.webp)
