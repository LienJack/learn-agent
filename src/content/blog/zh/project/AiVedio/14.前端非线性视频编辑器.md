...
![第 14 章全文重点总结图：前端非线性视频编辑器](./assets/summary-infographics/chapter-14-summary.webp)

> 图注：本章全文重点总结图，围绕非破坏式编辑、控制面与媒体面、Canonical Timeline、核心领域模型、整数时间模型、领域命令、Undo/Redo、自动保存和大型时间轴性能展开。
