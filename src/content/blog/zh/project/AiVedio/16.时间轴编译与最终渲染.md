...
![第 16 章全文重点总结图：时间轴编译与最终渲染](./assets/summary-infographics/chapter-16-summary.webp)

> 图注：本章全文重点总结图，围绕 Canonical Timeline、语义校验、Timeline Compiler、Render DAG、FFmpeg Filter Graph、分片渲染、断点续渲、Render Manifest 和安全发布展开。
