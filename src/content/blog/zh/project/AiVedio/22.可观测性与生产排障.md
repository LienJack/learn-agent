...
![第 22 章全文重点总结图：可观测性与生产排障](./assets/summary-infographics/chapter-22-summary.webp)

> 图注：本章全文重点总结图，围绕 task_id、attempt_id、trace_id、provider_job_id、Metrics、Logs、Traces、Business Events、队列年龄、Unknown Outcome、SLO、Runbook 和单任务排障面板展开。
