...
![第 03 章全文重点总结图：整体系统架构](./assets/summary-infographics/chapter-03-summary.webp)

> 图注：本章全文重点总结图，围绕三平面架构、基础组件边界、主链路、一次效果、异常恢复和常见错误架构展开。
...
![AiVedio 完整文字架构图：客户端层、边缘接入层、控制面、RocketMQ 异步总线、执行面与媒体数据面](./assets/03/full-text-architecture.webp)
...
![AiVedio 视频生成任务全链路架构图：素材上传、生成任务、供应商执行、媒体处理、计费结算与播放](./assets/03/video-generation-lifecycle.webp)
