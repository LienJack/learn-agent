...
![第 18 章全文重点总结图：高并发调度与资源隔离](./assets/summary-infographics/chapter-18-summary.webp)

> 图注：本章全文重点总结图，围绕准入控制、分层队列、公平调度、Provider Semaphore、Worker Slot、资源预留、原子认领、Fencing Token 和异常降级展开。
