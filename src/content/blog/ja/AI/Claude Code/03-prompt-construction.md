...
![03.核心机制-Prompt编写 スケッチ図 1：Prompt Runtime 的模型工作台](./assets/03-photo-01-prompt-runtime-workbench.jpg)
...
![03.コアメカニズム-Prompt作成 手描き図 2：system prompt の優先順位の階段](./assets/03-photo-02-system-prompt-priority.jpg)
...
![03.核心机制-Prompt编写 スケッチ図 3：CLAUDE.md 的记忆层级](./assets/03-photo-03-memory-layers.jpg)
...
![03.核心机制-Prompt编写 手描き図 4：安定セグメントと動的セグメントのキャッシュ境界](./assets/03-photo-04-cache-boundary.jpg)
