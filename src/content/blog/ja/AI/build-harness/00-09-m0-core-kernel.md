---
title: "M0 Core Kernel：本物の大規模モデルをシステムへ接続し、システムを乗っ取らせない"
description: "M0 Core Kernel は、実モデルの出力を ModelEvent と ToolIntent に正規化し、実行権、State、Event Log、Registry、Runtime Facade を core 側に残すための最小境界である。Provider は能力の入口だが、システムの中心..."
author: LienJack
pubDate: 2026-05-29
...
![M0 Core Kernel：本物の大規模モデルをシステムへ接続し、システムを乗っ取らせない](assets/00-09-m0-core-kernel/photo-01-core-provider-boundary.png)
...
![M0 Core Kernel：本物の大規模モデルをシステムへ接続し、システムを乗っ取らせない](assets/00-09-m0-core-kernel/mermaid-01.png)
...
![M0 Core Kernel：本物の大規模モデルをシステムへ接続し、システムを乗っ取らせない](assets/00-09-m0-core-kernel/mermaid-02.png)
...
![M0 Core Kernel：本物の大規模モデルをシステムへ接続し、システムを乗っ取らせない](assets/00-09-m0-core-kernel/mermaid-03.png)
...
![M0 Core Kernel：本物の大規模モデルをシステムへ接続し、システムを乗っ取らせない](assets/00-09-m0-core-kernel/mermaid-04.png)
...
![M0 Core Kernel：本物の大規模モデルをシステムへ接続し、システムを乗っ取らせない](assets/00-09-m0-core-kernel/photo-02-event-state-projection.png)
...
![M0 Core Kernel：本物の大規模モデルをシステムへ接続し、システムを乗っ取らせない](assets/00-09-m0-core-kernel/mermaid-05.png)
...
![M0 Core Kernel：本物の大規模モデルをシステムへ接続し、システムを乗っ取らせない](assets/00-09-m0-core-kernel/photo-03-runtime-facade-registry.png)
...
![M0 Core Kernel：本物の大規模モデルをシステムへ接続し、システムを乗っ取らせない](assets/00-09-m0-core-kernel/mermaid-06.png)
