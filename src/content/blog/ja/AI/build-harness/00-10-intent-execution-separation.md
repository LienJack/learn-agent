...
![モデルの意図が検証、承認、実行、観察としての結果返却を経る流れを横方向のパイプラインで説明する](assets/00-10-intent-execution-separation/photo-01-intent-execution-pipeline.jpg)
...
![モデルが提出するのは申請書であり、ファイルシステムや shell に実際に触れるのは Runtime であることを強調する](assets/00-10-intent-execution-separation/photo-02-model-runtime-boundary.jpg)
...
![ツール可視性と単発承認という 2 つのゲートを描き、権限が最後のポップアップではないことを示す](assets/00-10-intent-execution-separation/photo-03-permission-gates.jpg)
...
![完全なイベント事実の連鎖がモデル観察、監査、リプレイを同時に支える様子を示す](assets/00-10-intent-execution-separation/photo-04-observation-audit-replay.jpg)
