...
aliases:
  - Agent の進化経路
  - Chat Agent から Managed Agent へ
  - Agent が Harness に育つまで
---
...
![Agent の進化経路：Chat Agent -> Tool Agent -> Runtime Agent -> Managed Agent](assets/00-05-agent-evolution-path/photo-01-four-stage-evolution.png)
...
![Agent の進化経路：Chat Agent -> Tool Agent -> Runtime Agent -> Managed Agent](assets/00-05-agent-evolution-path/mermaid-01.png)
Agent は Chat から Tool、Runtime、Managed へ進むにつれて、現実のリスクを受け止める制御層を増やしていく。重要なのは能力の序列ではなく、どの現実リスクに触れているかで Harness の厚みを決めることだ。
...
![Agent の進化経路：Chat Agent -> Tool Agent -> Runtime Agent -> Managed Agent](assets/00-05-agent-evolution-path/mermaid-02.png)
...
![Agent の進化経路：Chat Agent -> Tool Agent -> Runtime Agent -> Managed Agent](assets/00-05-agent-evolution-path/photo-02-risk-pressure-axes.png)
...
![Agent の進化経路：Chat Agent -> Tool Agent -> Runtime Agent -> Managed Agent](assets/00-05-agent-evolution-path/mermaid-03.png)
Agent は Chat から Tool、Runtime、Managed へ進むにつれて、現実のリスクを受け止める制御層を増やしていく。重要なのは能力の序列ではなく、どの現実リスクに触れているかで Harness の厚みを決めることだ。
...
![Agent の進化経路：Chat Agent -> Tool Agent -> Runtime Agent -> Managed Agent](assets/00-05-agent-evolution-path/mermaid-04.png)
Agent は Chat から Tool、Runtime、Managed へ進むにつれて、現実のリスクを受け止める制御層を増やしていく。重要なのは能力の序列ではなく、どの現実リスクに触れているかで Harness の厚みを決めることだ。
...
![Agent の進化経路：Chat Agent -> Tool Agent -> Runtime Agent -> Managed Agent](assets/00-05-agent-evolution-path/mermaid-05.png)
Agent は Chat から Tool、Runtime、Managed へ進むにつれて、現実のリスクを受け止める制御層を増やしていく。重要なのは能力の序列ではなく、どの現実リスクに触れているかで Harness の厚みを決めることだ。
...
![Agent の進化経路：Chat Agent -> Tool Agent -> Runtime Agent -> Managed Agent](assets/00-05-agent-evolution-path/mermaid-06.png)
Agent は Chat から Tool、Runtime、Managed へ進むにつれて、現実のリスクを受け止める制御層を増やしていく。重要なのは能力の序列ではなく、どの現実リスクに触れているかで Harness の厚みを決めることだ。
...
![Agent の進化経路：Chat Agent -> Tool Agent -> Runtime Agent -> Managed Agent](assets/00-05-agent-evolution-path/photo-03-eval-and-handoff-flywheel.png)
